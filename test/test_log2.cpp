...
*/
// g++ -O2 -fopenmp test_log2.cpp -o test_log2.exe -lmorn -lglog -ldbghelp -llog4cpp
...
/*
    ...
    {
        int i=n%100;
        snprintf(buff,1024,mLogFormat5("Hello Morn, datai=%d, datad=%f, datas=%s"),datai[i],datad[i],&(datas[i][0]));
    }
    mTimerEnd("Morn");
    ////////////////////////////////////////////////////////////////////////////////////////////////////////
*/
